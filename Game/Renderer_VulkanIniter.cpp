...
void Renderer::createInstance() {
    ...
    appInfo.pApplicationName = "Game app";
    appInfo.applicationVersion = VK_MAKE_VERSION(1, 0, 0);
    appInfo.pEngineName = "Game Engine SN0";
...
void Renderer::pickPhysicalDevice() {
    ...
    std::vector<VkPhysicalDevice> devicesAll(deviceCount);
    vkEnumeratePhysicalDevices(instance, &deviceCount, devicesAll.data());

    std::vector<VkPhysicalDevice> devices;

    for (const auto& device : devicesAll) {
...
int Renderer::rateDeviceSuitability(VkPhysicalDevice device) {
    ...
    //std::cout << deviceProperties.deviceName << " - score: " << score << std::endl << std::endl;;
    return score;
}
...
void Renderer::createTextDescriptorSetLayout() {
    VkDescriptorSetLayoutBinding uboLayoutBinding{};
    uboLayoutBinding.binding = 0;
    uboLayoutBinding.descriptorCount = 1;
    uboLayoutBinding.descriptorType = VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER;
...
void Renderer::createTextGraphicsPipeline() {
...
void Renderer::createCommandPool() {
    ...
    if (vkCreateCommandPool(device, &poolInfo, nullptr, &commandPool1) != VK_SUCCESS) {
        throw std::runtime_error("failed to create graphics command pool!");
    }
    if (vkCreateCommandPool(device, &poolInfo, nullptr, &buffsPool) != VK_SUCCESS) {
        throw std::runtime_error("failed to create graphics command pool!");
    }
}
